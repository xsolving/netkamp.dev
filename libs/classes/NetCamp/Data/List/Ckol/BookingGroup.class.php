...
class NetKamp_Data_List_Ckol_BookingGroup extends NetKamp_Data_List{
	...
	public function __construct( &$outStatus ) {
		...
		$this->setSqlQueryData(
			array(
				"fieldsList"=>array(
                    ...
                    "CONVERT(VARCHAR(32), HashBytes('MD5', '" . NC_Config_Data::Instance()->getHashBase($this->referralYear) . "' + CAST(cli.IDCliente AS VARCHAR(8000)) ), 2) as customerIdHash"
				),
			...
			array(
				...
				"fieldsList"=>array(
					...
					*/
					...
					array( "alias"=>"customerIdHash",   "name"=>"customerIdHash",   "function"=>"" )
				),
				"fieldsListRedux"=>array(
					array( "alias"=>"customerId",  		"name"=>"IDCliente",  		"function"=>"" ),
					array( "alias"=>"fullCustomerData", "name"=>"fullCustomerData", "function"=>"utf8_encode" )
        ...
        $this->setRequestValuesTransformations(
            ...
            "fields"=>array(
                    "bookingId"=>array(
                        "keyField"=>"bookingId", 
                        "containerSets"=>array("__root","filter"),
                        "type"=>"querySql", 
